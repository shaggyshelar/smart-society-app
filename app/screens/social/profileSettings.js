    ...
    AsyncStorage.getItem("USER_LINKEDIN_TOKEN").then(token => {
      if (token) {
        thisRef.setState({
          ...
          linkedInToken: JSON.parse(token)
        });
      }
    });
            ...
            <View style={styles.header}>
              {renderIf(
                this.state.pictureUrl ==
                  "https://randomuser.me/api/portraits/men/49.jpg",
                <Avatar
                  img={require("../../assets/images/defaultUserImg.png")}
                  rkType="big"
                />
              )}
              {renderIf(
              ...
              <Container style={[styles.root]}>
                ...
                <View style={[styles.footerOffline]}>
                  {this.state.isOffline ? (
                    <RkText rkType="small" style={[styles.footerText]}>
                ...
                <View style={[styles.footer]}>
                  ...
                  <RkText rkType="small" style={[styles.companyName]}>
                    {" "}
